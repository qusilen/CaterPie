...
import Katagori_filtreleme from'./Katagori_filtreleme';
...
export default function BasicTabs() {
    ...
    return (
        ...
        <Grid>
            <Box>
                <Typography marginLeft={72} mt={5} variant="h6">
                    SİZE ÖZEL ÖNERİLENLER
                </Typography>
            ...
            <Grid>
                <Box sx={{ marginLeft: "300px", width: '90%', mt: "50px" }}>
            ...
            <Grid>
                <Box sx={{ marginLeft: "300px", width: '90%', mt: "-1030px", ml: "900px" }}>
                    <Card sx={{ maxWidth: 215 }}>
                        <CardActionArea>
                            <CardMedia
                                component="img"
